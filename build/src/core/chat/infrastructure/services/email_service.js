...
const mail_config_1 = require("./config/mail_config");
...
let MailService = class MailService {
    ...
    sendMailToMultipleRecipients = async (recipients, subject, html) => {
        try {
            let response = [];
...
exports.MailService = MailService = __decorate([
    ...
    __param(0, (0, tsyringe_1.inject)(mail_config_1.IIEmailConfig)),
