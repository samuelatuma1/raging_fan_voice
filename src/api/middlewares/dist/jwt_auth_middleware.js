...
var JwtMiddlewareAuth = /** @class */ (function () {
    function JwtMiddlewareAuth(authLogic) {
        var _this = this;
        this.authLogic = authLogic;
        this.verifyUserHasAccess = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var accessCode, isValidAccessCode;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        accessCode = (_a = req.headers.access_code) !== null && _a !== void 0 ? _a : "";
                        console.log(accessCode);
                        return [4 /*yield*/, this.authLogic.isValidAccessCode(accessCode)];
                    case 1:
                        isValidAccessCode = _b.sent();
        ...
        this.getAccessTokenPayloadFromToken = function (req) {
            var _a, _b;
