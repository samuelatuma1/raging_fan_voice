...
var chatgpt_config_1 = require("../config/chatgpt_config");
...
var ChatGPTConversationAI = /** @class */ (function () {
    function ChatGPTConversationAI(apiService, chatgptConfig) {
        var _this = this;
        this.apiService = apiService;
        this.chatgptConfig = chatgptConfig;
        this.message = function (instruction, conversationThread, userMessage) { return __awaiter(_this, void 0, Promise, function () {
            var latestMessage, body, apiRequestData, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        latestMessage = new ai_message_1.AIMessageUnit({
                        ...
                        apiRequestData = new api_request_1.ApiRequest({
                        ...
                        return [4 /*yield*/, this.apiService.apiRequest(apiRequestData)];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, response.choices[0]];
                }
            });
        }); };
    }
    ChatGPTConversationAI = __decorate([
        ...
        __param(1, tsyringe_1.inject(chatgpt_config_1.IIChatGPTConfig))
    ], ChatGPTConversationAI);
    return ChatGPTConversationAI;
}());
