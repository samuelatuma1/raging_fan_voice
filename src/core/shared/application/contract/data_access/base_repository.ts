import { SortOrder } from "../../../domain/enum/sort_order";
...
export default interface IBaseRepository<TEntity extends BaseEntity<TId>, TId> {
    ...
    getPagedAsyncDecrement(query:  Partial<{[k in keyof TEntity]: any}>, lastItemId: TId | null, pageSize?: number, sort?: {[key: string]: any}) : Promise<TEntity[]>
